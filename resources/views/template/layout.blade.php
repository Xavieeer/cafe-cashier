        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="/"><i
                                class="fa-solid fa-home"></i><span class="nav-text">Dashboard</span></a>
...
<li><a href="{{ url('menu')}}"><i
    class="fa-solid fa-bell-concierge"></i><span class="nav-text">Menu</span></a>
</li>

<li><a href="{{ url('stok')}}"><i
    class="fa-solid fa-boxes-stacked"></i><span class="nav-text">Stok</span></a>
</li>

<li><a href="{{ url('pelanggan')}}"><i
    class="fa-solid fa-people-group"></i><span class="nav-text">Pelanggan</span></a>
</li>

<li><a href="{{ url('meja')}}"><i
