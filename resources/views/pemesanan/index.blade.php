        ...
        <div class="container mb-5">
            ...
            <div class="row w-full">
                ...
                <div class="item-content col-md-3">
                    <div class="card"
                        style="width: 500px; box-shadow: 0 8px 20px rgba(0, 0, 0, 0.1); border-radius: 10px;">
                        <div class="card-body">
                            <h3>Orders</h3>
                            ...
                            <div>
                                <button type="button" class="btn w-3" id="btn-bayar"
                                    style="background-color: #1b0164; color: #ffffff;">Bayar</button>
                            </div>
                        </div>
                    </div>
                </div>
